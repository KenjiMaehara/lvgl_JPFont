...
// UART設定用ビットマスク
#define UART_NB_BIT_MASK 0x03
#define UART_PARITY_MASK 0x0C
#define UART_NB_STOP_BIT_MASK 0x04

// データビット数
#define UART_NB_BIT_5 0x00
#define UART_NB_BIT_6 0x01
#define UART_NB_BIT_7 0x02
#define UART_NB_BIT_8 0x03

// パリティ設定
#define UART_PARITY_NONE 0x00
#define UART_PARITY_ODD 0x04
#define UART_PARITY_EVEN 0x08

// ストップビット数
#define UART_NB_STOP_BIT_1 0x00
#define UART_NB_STOP_BIT_15 0x01 // 1.5 ストップビット
#define UART_NB_STOP_BIT_2 0x02
